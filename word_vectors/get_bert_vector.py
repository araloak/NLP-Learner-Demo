...
model_path=sys.path[0]+"/model/chinese_L-12_H-768_A-12"
config_path = sys.path[0]+'/model/chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = sys.path[0]+'/model/chinese_L-12_H-768_A-12/bert_model.ckpt'
dict_path = sys.path[0]+'/model/chinese_L-12_H-768_A-12/vocab.txt'
...
if __name__=="__main__":
    ...
    #直接得到[1,8,768]维的词向量矩阵，但未经过fine tune
